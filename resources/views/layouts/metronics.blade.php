            ...
            <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                ...
                <x-mikro.pageToolbar>
                    ...
                    <x-slot name="actions">
                        ...
                        <!--end::Wrapper-->
                        <!--begin::Button-->
                        <x-nano.buttonLink href="#" class="btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app" id="kt_toolbar_primary_button">Create</x-nano.buttonLink>
                        <!--end::Button-->
                    </x-slot>
                </x-mikro.pageToolbar>
                <!--end::Toolbar-->
            ...
            <div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
                ...
                <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
                    ...
                    <div class="text-dark order-2 order-md-1">
                        ...
                        <a href="#" target="_blank" class="text-gray-800 text-hover-primary">Adib Pratama</a>
                    </div>
                    <!--end::Copyright-->
                    <!--begin::Menu-->
